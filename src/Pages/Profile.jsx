...
const Profile = () => {
    ...
    return (
            ...
            <div><img className="h-[150px] w-[150px] rounded-full ring-4 ring-gray-400 mx-auto my-10" src={user?.photoURL ? user?.photoURL : 'https://i.ibb.co/t23zmR8/Logo.png'} alt="" /></div>
